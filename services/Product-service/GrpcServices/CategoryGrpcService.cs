...
/// </summary>
public class CategoryGrpcService : ProductService.ProductServiceBase
{
    private readonly ICategoryService _categoryService;
    private readonly ILogger<CategoryGrpcService> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="CategoryGrpcService"/> class.
    /// </summary>
    /// <param name="categoryService">The core service for category operations.</param>
    /// <param name="logger">The logger instance.</param>
    public CategoryGrpcService(ICategoryService categoryService, ILogger<CategoryGrpcService> logger)
    {
